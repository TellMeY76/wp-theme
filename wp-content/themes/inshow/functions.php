...
function inshow_scripts() {
    ...
    wp_enqueue_script( 'custom-message-js', get_template_directory_uri() . '/js/custom-message.js', array( 'jquery' ), '1.0.0', true );
    ...
    wp_enqueue_script( 'custom-chat-js', get_template_directory_uri() . '/js/custom-chat.js', array( 'jquery' ), '1.0.0', true );
    wp_enqueue_script( 'custom-category-js', get_template_directory_uri() . '/js/custom-category.js', array( 'jquery' ), '1.0.0', true );
...
if ( function_exists('register_sidebar') ) {
    ...
    register_sidebar(array(
        ...
        'id'            => 'footer_column_2',
        'description'   => __( 'Widgets in this area will be shown in the second column of the footer.', 'your-textdomain' ),
        'before_widget' => '<div class="footer-widget">',
        'after_widget'  => '</div>',
        'before_title'  => '<h3 class="footer-widget-title">',
        'after_title'   => '</h3>',
    ...
    register_sidebar(array(
        ...
        'id'            => 'footer_column_4',
        'description'   => __( 'Widgets in this area will be shown in the fourth column of the footer.', 'your-textdomain' ),
        'before_widget' => '<div class="footer-widget">',
        'after_widget'  => '</div>',
        'before_title'  => '<h1 class="footer-widget-title">',
        'after_title'   => '</h1>',
...
function display_chat_data_page() {
    ...
    <div class="wrap">
        ...
        <?php if ($results): ?>
            <table class="widefat">
                <thead><tr><th><?php echo esc_html__('Product Name', 'your-text-domain'); ?></th><th><?php echo esc_html__('Email', 'your-text-domain'); ?></th><th><?php echo esc_html__('Date', 'your-text-domain'); ?></th></tr></thead>
                <tbody>
...
class Footer_Info_Widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <input type="hidden" id="<?php echo $this->get_field_id( 'logo_url' ); ?>" name="<?php echo $this->get_field_name( 'logo_url' ); ?>" value="<?php echo esc_url( $logo_url ); ?>">
            <?php if ( $logo_url ) : ?>
                <img src="<?php echo esc_url( $logo_url ); ?>" id="<?php echo $this->get_field_id( 'logo_preview' ); ?>" style="max-width:100%;"/>
            <?php endif; ?>
            <input type="button" class="button button-secondary" value="<?php _e( 'Upload Image', 'your-textdomain' ); ?>" id="footer_upload_btn">
        </p>

        <p>
            <label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address:', 'your-textdomain'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('officeHour'); ?>"><?php _e('Office Hours:', 'your-textdomain'); ?></label>
